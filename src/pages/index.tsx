...
const CommunityCard: FC<PropsWithChildren> = ({ children }) => {
  return (
    <div className="card shrink-0 w-96 bg-base-100 shadow-xl">
      <figure>
  ...
  return (
    <>
      <div className="container mx-auto max-w-screen-md bg-slate-50 text-black">
        ...
        <div
          className="relative w-full flex gap-0 snap-x snap-mandatory overflow-x-auto
          [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']"
        >
          <section className="shrink-0 w-full bg-white dark:bg-gray-900">
